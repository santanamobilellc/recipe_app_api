...
class PublicUsersApiTests(TestCase):
    ...
    def test_password_to_short(self):
        """test that the password is 5 or more characters"""
        payload = {'email': 'jjc@jjc.com', 'password': '04'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'j@j.com', 'password': 'test_pass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='j@j.com', password='test_pass')
        payload = {'email': 'j@j.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
